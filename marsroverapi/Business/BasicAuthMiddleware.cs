...
public class BasicAuthMiddleware
{
    ...
    public BasicAuthMiddleware(RequestDelegate next, string realm, IUserRepository userRepository)
    {
        _next = next;
        _realm = realm;
    ...
    public bool IsAuthorized(string username, string password)
    {
        ...
        // var userlist = _userRepository.Get(x => x.Username == username && x.Password == password).ToList();
